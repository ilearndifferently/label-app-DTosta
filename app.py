...
def extract_text_from_image(uploaded_file, index):
 raw_bytes = uploaded_file.getvalue()
 _ = preprocess_for_ocr(raw_bytes)
 time.sleep(1.5)
 scenario = index % 3
 if scenario == 0: return {"Brand Name":"OLD TOM DISTILLERY","Class/Type":"Kentucky Straight Bourbon Whiskey","Warning":"GOVERNMENT WARNING: (1) According to the Surgeon General..."}
 elif scenario == 1: return {"Brand Name":"Old Tom Distilery","Class/Type":"Kentucky Straight Bourbon Whiskey","Warning":"GOVERNMENT WARNING: (1) According to the Surgeon General..."}
...
if uploaded_files:
 ...
 for i, file in enumerate(uploaded_files):
  ...
  with st.spinner('Analyzing image...'):
   extracted_data = extract_text_from_image(file, i)
